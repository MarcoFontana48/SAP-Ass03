...
public final class EndpointPath {
    ...
    public static final String EBIKE_SERVICE_SQL_CONFIG = "/ebike-service/config/sql";
    public static final String EBIKE_SERVICE_MONGO_CONFIG = "/ebike-service/config/mongo";
