...
/**
 * Class that implements the RequestsCounter interface and uses Prometheus to count the number of requests received by the service.
 */
public final class PrometheusRequestsCounter implements RequestsCounter {
    private static final Counter REQUESTS_METHOD_STATUS_NUM_COUNTER = Counter.build()
            ...
            .help("Total requests to user service divided by method type and status.")
